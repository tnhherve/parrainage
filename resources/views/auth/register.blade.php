                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control{{ $errors->has('niveau') ? ' is-invalid' : '' }}" id="niveau" name="niveau">
                                  <option value="niveau1">Niveau I</option>
                                  <option value="niveau2">Niveau II</option>
                                  <option value="niveau4">Niveau IV</option>
                                  <option value="niveau5">Niveau V</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control{{ $errors->has('option') ? ' is-invalid' : '' }}" id="option" name="option">
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="photo" type="file" class="form-control custom-file-input " name="photo" required>
                                <label class="form-control{{ $errors->has('photo') ? ' is-invalid' : '' }} custom-file-label " for="photo">Choose file...</label>
